...
public final class p149 {
    ...
    // For the sequence of numbers in the grid at positions (x, y), (x+dx, y+dy),
    // (x+2*dx, y+2*dy), ... until the
    // last in-bounds indices, this function returns the maximum sum among all
    // possible substrings of this sequence.
    ...
    private static final class LfgRandom {
        ...
        // Returns the number that was generated n steps ago, where 1 <= n <=
        // history.length.
