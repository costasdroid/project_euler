...
public class Solution054 {
	...
	public static void main(String[] args) {
		...
		int sol = 0;
		for (String h : hands) {
			Hand h1 = new Hand(h.substring(0, 14));
			Hand h2 = new Hand(h.substring(15, 29));
			if (h1.category>h2.category) {
				sol++;
			}
			if (h1.category==h2.category) {
				for (int i=0; i<h1.highest.size(); i++) {
					if (h1.highest.get(i)>h2.highest.get(i)) {
						sol++;
						break;
					}
					if (h1.highest.get(i)<h2.highest.get(i)) {
	...
	static String s = "8C TS KC 9H 4S 7D 2S 5D 3S AC\n" + 
